    ...
    <section className="bg-plum-900 py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="text-center max-w-xl mx-auto mb-16">
          <p className="eyebrow text-rose-gold mb-3">The Charminar Traders Promise</p>
          <h2 className="font-display text-cream text-4xl md:text-5xl">Why Choose Charminar Traders</h2>
        </div>
